            ...
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe
                        ...
                        src="https://www.google.com/maps/embed/v1/place?q=51+Hartland+Avenue,+Emerson,+NJ,+USA&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" />
                ...
                <form netlify="true" name="contact" onSubmit={handleSubmit} className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    <h2 className="text-white sm:text-4x1 text-3xl mb-1 font-medium title-font">
                        Contact Me!
                    </h2>
                    <p className="leading-relaxed mb-5">I am currently seeking internships or full-time employment. If you are interested in what I can provide for you, leave a name, email and message for me. I'd love to hear from you😁</p>
